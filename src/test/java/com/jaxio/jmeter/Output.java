																		...
																		new XMLAssertion() //
																				...
																				new ResponseAssertion() //
																						...
																						new CollectionProp() //
																								.name("Asserion.test_strings") //
																								.add("-698385692",
																										"<partial-response><redirect url=\"/${CONTEXT}/home.faces\"></redirect></partial-response>") //
																						),//
																				new HashTree() //
																		),//
																new HTTPSamplerProxy() //
																		...
																		new XMLAssertion() //
																				...
																				new ResponseAssertion() //
																						...
																						new CollectionProp() //
																								.name("Asserion.test_strings") //
																								.add("-1934985013",
																										"<partial-response><changes><update id=\"form:username\">") //
																						),//
																				new HashTree(),//
																				new ResponseAssertion() //
																						.guiclass("AssertionGui") //
																				...
																				new CollectionProp() //
																						...
																						new ElementProp() //
																								...
																								new ElementProp() //
																										...
																										.add("Argument.name", "javax.faces.partial.render") //
																										.add("Argument.value",
																												"form:messages form:searchResults") //
																										.add("Argument.metadata", "=") //
																										.add("HTTPArgument.use_equals", true),//
																								new ElementProp() //
																										.name("form:search") //
																		...
																		new XMLAssertion() //
																				...
																				new ResponseAssertion() //
																						...
																						new CollectionProp() //
																								.name("Asserion.test_strings") //
																								.add("-1678136383",
																										"<partial-response><changes><update id=\"form:messages\">") //
																						),//
																				new HashTree(),//
																				new ResponseAssertion() //
																						.guiclass("AssertionGui") //
																				...
																				new RegexExtractor() //
																						...
																						.add("RegexExtractor.regex",
																								"<a id=\"([^\"]+)\" href=\"#\" class=\"ui-commandlink ui-widget ui-button\" aria-label=\"Edit admin\"") //
																						.add("RegexExtractor.template", "$1$") //
																						.add("RegexExtractor.default", "") //
																						.add("RegexExtractor.match_number", "0"),//
																				new HashTree(),//
																				new RegexExtractor() //
																						...
																						.add("RegexExtractor.regex",
																								"<a id=\"([^\"]+)\" href=\"#\" class=\"ui-commandlink ui-widget ui-button\" aria-label=\"View admin\"") //
																						.add("RegexExtractor.template", "$1$") //
																						.add("RegexExtractor.default", "") //
																						.add("RegexExtractor.match_number", "0"),//
																				new HashTree() //
